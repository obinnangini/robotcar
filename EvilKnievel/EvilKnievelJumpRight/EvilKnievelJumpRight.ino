...
const char demo_name_line1[] PROGMEM = "PID Line test";
const char demo_name_line2[] PROGMEM = "follower";

// A couple of simple tunes, stored in program space.
const char welcome[] PROGMEM = ">g32>>c32";
const char go[] PROGMEM = "! O6 L8"
...
void turn(double r, int velocity) {
  ...
  if(ratioBottom < 2.0) {
    OrangutanMotors::setSpeeds(ratioBottom*velocity+10, ratioBottom*velocity);
  } else {
    OrangutanMotors::setSpeeds(ratioBottom*velocity+5, ratioBottom*velocity);
  }
}
...
void loop()
{
  unsigned int position = robot.readLine(sensors, IR_EMITTERS_ON);
   ...
   // If off the line, jump. Else, follow line.
   if(position == 4000 || position == 0) {
      ...
      //  }
        ...
        OrangutanMotors::setSpeeds(velocity, velocity);
      }
   } else {
    //TODO: Reset R when following line to be able to jump again?
    //r=15.0
